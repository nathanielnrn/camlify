...
let song_name_to_mp3 song_name = Music_data.song_name_to_mp3_file song_name Music_data.all_songs_objects
...
print_endline (List.nth (Music_data.select_playlist selected_playlist) 0);
  {
    ...
    current_song_mp3_file = song_name_to_mp3 (List.nth (Music_data.select_playlist selected_playlist) 0);
    current_song_idx = 0;
  ...
  try
    ...
    |> fun x ->
      Legal{
        ...
        current_song_mp3_file = song_name_to_mp3 song_name;
...
let play_song_by_idx idx st = 
  ...
  List.nth st.current_playlist idx |> fun x ->
    Legal{
      current_song_name = x;
      current_song_mp3_file = song_name_to_mp3 x;
...
let add_song_to_playlist song_name st = 
    ...
    current_song_mp3_file = song_name_to_mp3 st.current_song_name;
